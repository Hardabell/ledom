                        ...
                        if ($execute->num_rows > 0){
                            ...
                            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr id='data'>
                                    ...
                                    <a class=\"btn btn-yellow\" data-a=".$data['nama_kriteria']." id='hapus' href='./proses/proseshapus.php/?op=kriteria&id=".$data['id_kriteria']."'><i class='fa fa-trash-alt'></i></a></td>
                                </div></tr>";
                                $no++;
                            }
                        }else{
