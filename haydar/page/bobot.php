            ...
            <div class="panel-middle">
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                        <?php
                        $query="SELECT bobot_kriteria.id_lomba AS idbarangbobot,lomba.nama_lomba AS nama_lomba FROM bobot_kriteria INNER JOIN lomba WHERE bobot_kriteria.id_lomba=lomba.id_lomba GROUP BY idbarangbobot ORDER BY idbarangbobot ASC";
                        ...
                        if ($execute->num_rows > 0){
                            ...
                            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr id='data'>
                                    ...
                                    <a class=\"btn btn-yellow\" data-a=".$data['nama_lomba']." id='hapus' href='./proses/proseshapus.php/?op=bobot&id=".$data['idbarangbobot']."'><i class='fa fa-trash-alt'></i></a></td>
                                </div></tr>";
                                $no++;
                            }
                        }else{
