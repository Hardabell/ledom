                        ...
                        if ($execute->num_rows > 0){
                            ...
                            while($data=$execute->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr id='data'>
                                    ...
                                    <a class=\"btn btn-yellow\" data-a=".$data['nama_peserta']." id='hapus' href='./proses/proseshapus.php/?op=supplier&id=".$data['id_peserta']."'><i class='fa fa-trash-alt'></i></a>
                                    </div></td>
                                </tr>";
                                $no++;
                            }
